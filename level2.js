class Level2 extends GameplayScene {
    ...
    onEnter() {
        ...
        let topOb1 = this.addObstacle(800, 200, 1).setTint(0x75ff7a);
        let botOb1 = this.addObstacle(800, this.h - 250, 2).setTint(0x75ff7a);
        this.setFollow(botOb1, topOb1);

        let topGate = this.addObstacle(1500, this.h / 2 - 150, 0, false).setTint(0x75ff7a);

        this.addPlate(500, this.h - 10, [topGate, botOb1], ["raise", "lower"], [350, 150], true).setTint(0x75ff7a);

        let topOb2 = this.addObstacle(1250, this.h/2 - 150, 1).setTint(0xff8b6e);
        let botOb2 = this.addObstacle(1250, this.h - 150, 1).setTint(0xff8b6e);
        this.setFollow(topOb2, botOb2);

        this.addPlate(1900, this.h / 2 + 5, [botOb2], ["raise"], [150], true).setTint(0xff8b6e);

        let topOb3 = this.addObstacle(2600, this.h / 2 - 5, 3, false).setTint(0x7775ff);

        this.addPlate(2100, this.h + 10, [topOb3], ["lower"], [445], false).setTint(0x7775ff);
